...
public class MediaStorageServiceTests
{
    ...
    public async Task CopyToAppDataAsync_PreservesFileNameAndExtension()
    {
        ...
        try
        {
            ...
            var service = new Transcriba.Core.Services.MediaStorageService(Path.Combine(tempRoot, "media"));
    ...
    public void DeleteMedia_RemovesTranscriptionFolder()
    {
        ...
        try
        {
            var service = new Transcriba.Core.Services.MediaStorageService(tempRoot);
